...
public class QuantumTeleporterScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    final QuantumTeleporterBlockEntity blockEntity;

    public QuantumTeleporterBlockEntity getBlockEntity() {
        return blockEntity;
    }


    public QuantumTeleporterScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public QuantumTeleporterScreenHandler(int syncId, PlayerInventory playerInventory,
                                          BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.QUANTUM_TELEPORTER_SCREEN_HANDLER, syncId);
        checkSize(((Inventory) blockEntity), 1);
        this.inventory = (Inventory)blockEntity;
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((QuantumTeleporterBlockEntity) blockEntity);
