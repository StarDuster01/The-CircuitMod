...
import net.stardust.circuitmod.screen.slot.CoalSlot;
import net.stardust.circuitmod.screen.slot.DiamondSlot;


public class PCBStationScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    final PCBStationBlockEntity blockEntity;

    public PCBStationBlockEntity getBlockEntity() {

        return blockEntity;
    }


    public PCBStationScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
