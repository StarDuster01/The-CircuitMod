...
public class RubberTapScreenHandler extends ScreenHandler {
    ...
    final RubberTapBlockEntity blockEntity;

    public RubberTapBlockEntity getBlockEntity() {

        return blockEntity;
    }


    public RubberTapScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public RubberTapScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.blockEntity = ((RubberTapBlockEntity) blockEntity);
