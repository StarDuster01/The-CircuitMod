...
public class ModBlocks {
    ...
    public static final Block FLUID_TANK = registerBlock("fluidtank",
            new FluidTank(FabricBlockSettings.copyOf(Blocks.GLASS).sounds(BlockSoundGroup.STONE).nonOpaque()));
    ...
    public static final Block OIL_TOWER_FRAME = registerBlock("oil_tower_frame",
            new OilTowerFrame(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.METAL).nonOpaque()));
