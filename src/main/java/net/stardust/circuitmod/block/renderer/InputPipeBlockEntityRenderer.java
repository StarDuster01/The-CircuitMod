...
import net.stardust.circuitmod.block.entity.InputPipeBlockEntity;
import net.stardust.circuitmod.block.entity.PipeBlockEntity;

public class InputPipeBlockEntityRenderer implements BlockEntityRenderer<InputPipeBlockEntity> {



    public InputPipeBlockEntityRenderer(Context context) {
    ...
    @Override
    public void render(InputPipeBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
