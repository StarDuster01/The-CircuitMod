...
public class PumpJackExtraSlaveBlockEntity extends AbstractTechSlaveBlockEntity implements ExtendedScreenHandlerFactory {
    public PumpJackExtraSlaveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.PUMP_JACK_EXTRA_SLAVE_BE,pos, state);
    }
