...
public class PumpJackBaseSlaveBlockEntity extends AbstractTechSlaveBlockEntity implements ExtendedScreenHandlerFactory {
    public PumpJackBaseSlaveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FUEL_GENERATOR_BASE_SLAVE_BE,pos, state);
    }

    // In PumpJackInventorySlaveBlockEntity.java
