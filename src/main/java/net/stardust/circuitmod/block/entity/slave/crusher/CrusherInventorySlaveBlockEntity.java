...
public class CrusherInventorySlaveBlockEntity extends BlockEntity implements ImplementedInventory {
    public CrusherInventorySlaveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CRUSHER_INVENTORY_SLAVE_BE,pos, state);
    }
