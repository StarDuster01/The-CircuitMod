...
public class RefineryEnergySlaveBlock extends BlockWithEntity {
    public RefineryEnergySlaveBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new RefineryEnergySlaveBlockEntity(pos, state);
    }
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient()) {
            ...
            if (be instanceof RefineryEnergySlaveBlockEntity) {
                BlockPos masterPos = ((RefineryEnergySlaveBlockEntity) be).getMasterPos();
                if (masterPos != null) {
