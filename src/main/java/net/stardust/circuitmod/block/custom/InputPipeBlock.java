...
public class InputPipeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public InputPipeBlock(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.INPUT_PIPE_BE, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
